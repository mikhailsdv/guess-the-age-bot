...
const greetMessage = trueTrim(`
	...
	📋 Правила просты: я кидаю вам фото человека, а ваша задача угадаеть его возраст. Чем точнее вы отвечаете, тем меньше баллов теряете.
